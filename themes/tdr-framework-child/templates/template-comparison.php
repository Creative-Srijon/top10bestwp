...
<?php
        ...
        $comparison_query_args = array( 
            ...
            'meta_key' => 'thunder_plugin_products_int_rating',
                ...
                <section class='comparison-table'>
                    ...
                    <div class="span7" id="review">
                        ...
                        <div class="sub-ratings">
							<div id="support">
								<h6><i class="icon-comment"></i> Customer Support</h6>
								<?php echo( "<strong>{$comparison_points['customer-service']}</strong>" ); ?>
							</div><!-- end #support -->
							<div id="one-click">
								<h6><i class="icon-cog"></i> One-Click Install?</h6>
								<?php echo( "<strong>{$comparison_points['one-click']}</strong>" ); ?>
							</div><!-- end #one-click -->
							<div id="price">
								<h6><i class="icon-shopping-cart"></i> Price</h6>
								<?php echo ( "<strong>{$comparison_points['cheap-price']}</strong>" ); ?><br /><a href="#">Visit Site</a>
							</div><!-- end #price -->
							<div id="bandwidth">
								<h6><i class="icon-signal"></i> Bandwidth</h6>
								<?php echo ( "<strong>{$comparison_points['cheap-bandwidth']}</strong>" ); ?>
							</div><!-- end #bandwidth -->
                        </div><!-- end .sub-ratings -->
                    </div><!-- end .our-review -->
